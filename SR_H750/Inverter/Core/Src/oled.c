...
void OLEDShowData(u8 x,u8 y,u8 temp)
{
	switch(temp)
	{
		case  0: OLED_ShowStr(x,y,(uint8_t *)"0",1);
		break;
		case  1: OLED_ShowStr(x,y,(uint8_t *)"1",1);
		break;
		case  2: OLED_ShowStr(x,y,(uint8_t *)"2",1);
		break;
		case  3: OLED_ShowStr(x,y,(uint8_t *)"3",1);
		break;
		case  4: OLED_ShowStr(x,y,(uint8_t *)"4",1);
		break;
		case  5: OLED_ShowStr(x,y,(uint8_t *)"5",1);
		break;
		case  6: OLED_ShowStr(x,y,(uint8_t *)"6",1);
		break;
		case  7: OLED_ShowStr(x,y,(uint8_t *)"7",1);
		break;
		case  8: OLED_ShowStr(x,y,(uint8_t *)"8",1);
		break;
		case  9: OLED_ShowStr(x,y,(uint8_t *)"9",1);
		break;		
	}
}
