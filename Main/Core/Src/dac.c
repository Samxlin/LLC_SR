...
void MX_DAC3_Init(void)
{
  ...
  */
  ...
  /* USER CODE BEGIN DAC3_Init 2 */
	//Set DAC SR Channel register
	if(HAL_DAC_SetValue(&hdac3,DAC_CHANNEL_1,DAC_ALIGN_12B_R,1000) != HAL_OK) 
  {
    Error_Handler();    
  }
	if(HAL_DAC_SetValue(&hdac3,DAC_CHANNEL_2,DAC_ALIGN_12B_R,1000) != HAL_OK) 
  {
    Error_Handler();    
  }
	
	//Enable DAC SR Channel
